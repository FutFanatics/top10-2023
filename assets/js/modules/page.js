(function($){
	...
	$(document).ready(function () {
		...
		$(".shirt-fav").click(function () {
			...
			var $currentCardTop = $(".card-top[data-currentposition='" + currentCardTop + "']");
			...
			success: function (data) {
				if (data.status === true && data.data && data.data.votos) {
					...
					$.each(votos, function (index, item) {
						...
						var newItem = $("<div class='col-10 card-ranking d-flex'>"
	...
	const objetos = [
		/* alemanha fem */
		{
			...
			descricao: "A campanha na Copa do Mundo Feminina pode ter sido decepcionante, mas uma coisa não se pode negar: a camisa da Alemanha é uma das coisas mais lindas que foi vista em 2023. O manto verde ficou maravilhoso, não é?",
			preco: "R$ 99,99",
		...
		/* Adidas Espanha Fem. III */
		{
			...
			descricao: "As campeãs do Mundo também não podiam ficar de fora. A camisa away da Espanha no Mundial da Austrália também fez bastante sucesso. Com cores em azul e vermelho, a camisa também faz parte das dez mais bonitas de 2023.",
			preco: "R$ 79,99",
		...
		/* Adidas Suécia Fem. III */
		{
			...
			descricao: "A camisa da Seleção Sueca de Futebol facilmente está entre as 10 mais bonitas do ano de 2023. Com detalhes em azul, contrapondo tons diferentes, a camisa da terceira colocada no Mundial da Austrália fez sucesso.",
			preco: "R$ 79,99",
		...
		/* Adidas Itália Away */
		{
			...
			descricao: "Esculpida para os deuses do cálcio, a camisa Away da Azzurra para 2023, criada pela Adidas, celebra o legado da cultura italiana. O manto traz visual na cor branca, exibindo padrão marmorizado ao longo de seu corpo, além de possuir, na nuca, o nome 'Italia'.",
			preco: "R$ 79,99",
		...
		/* Adidas Colombia Feminina Away*/
		{
			...
			descricao: "Do Rio Caño Cristales para a Terra do Canguru! A camisa away da Colômbia na Copa do Mundo Feminina da Austrália foi uma homenagem a um dos fenômenos mais incríveis da natureza, as cores do Rio Cinco Cores. Vale a pesquisa e vale o voto nessa beleza da Adidas.",
			preco: "R$ 79,99",
		...
		/* Adidas México Away */
		{
			...
			descricao: "Inspirada na deslumbrante beleza da natureza mexicana, a Adidas apresenta a nova versão feminina da camisa Away do México para 2023. O manto exibe design na cor branca e estampa com manchas verdes representando o tubarão-baleia que habita as costas do país.",
			preco: "R$ 79,99",
		...
		/* Adidas Itália Home*/
		{
			...
			descricao: "A média do preço do mármore é de R$800. Mas nesse mármore italiano chamado “Mantello dell'Azzurra”, uma tradução simples de “Manto da Azzurra”, é certamente uma das camisas mais bonitas do ano. Além disso, é o retorno da marca alemã como fornecedora da seleção.",
			preco: "R$ 79,99",
		...
		/* Adidas Jamaica Away */
		{
			...
			descricao: "Essa aqui além de linda, é representativa. Valeu tanto a pena e foi tão bem produzida pela Adidas que foi lançada na semana de moda de Milão. A camisa está linda e conta com detalhes marcantes da cultura jamaicana.",
			preco: "R$ 79,99",
		...
		{ 
			...
			descricao: "'Garra catracha' A camisa Home de Honduras para 2024, da Joma, é o manto perfeito para os admiradores da Seleção Hondurenha vestirem toda a paixão. Com design pensando na história da Seleção Hondurenha, a peça traz o escudo aplicado, além da bandeira do país destacada abaixo da nuca.",
			preco: "R$ 79,99",
		...
		/* Volt Criciúma III */
		{
			...
			descricao: "Passado e presente se unem ao manto três do clube catarinense. A camisa desenvolvida pela Volt lembra a origem do clube. A camisa conquistou fãs no Brasil todo e claro, trouxe sorte ao Tigre, que conseguiu o acesso para a Série A de 2024.",
			preco: "R$ 99,99",
		...
		/* Onça Amazonas I */
		{
			...
			descricao: "Que a onça pintada é linda e imponente você já sabia. O que você não fazia ideia é que a marca própria do Amazonas produziria mantos tão lindos como os da temporada 2023. A camisa I do clube de Manaus foi sucesso de vendas e de crítica e uma das favoritas para levar o Top 10 de Clubes Brasileiros.",
			preco: "R$ 79,99",
		...
		/* Kappa Bangu III*/
		{
			...
			descricao: "Das origens da Escócia, ao Estádio de Moça Bonita. A camisa III do Bangu celebra a origem do clube banguense. Fundado por operários de uma fábrica escocesa, o manto azul homenageia o país europeu e os fundadores do clube do subúrbio do Rio.",
			preco: "R$ 79,99",
		...
		/* 1909 Coritiba III */
		{
			...
			descricao: "Rock é rock, isso não se discute. O Coritiba lançou o manto mais Rock n' Roll de 2023. A camisa III do clube paranaense faz referência ao Green Hell, festa da torcida Côxa Branca quando pelas ruas do Alto da Glória em dia de jogos.",
			preco: "R$ 79,99",
		...
		/* Camisa Puma Palmeiras I*/
		{
			...
			descricao: "A Terceira Academia! Essa camisa do Palmeiras, desenhada pela Puma, foi uma das mais bonitas da temporada. A camisa é uma homenagem e a sequencia de times históricos do Alviverde. A Terceira Academia chegou como favorita!",
			preco: "R$ 79,99",
		 ...
		 /* Camisa Adidas Flamengo III*/
		{
			...
			descricao: "Que prazer vê-lo brilhar! A camisa do Fla traz design na cor preta com aplicação em furta-cor, que muda o tom de acordo com a luz refletida O grande destaque do uniforme fica para a aplicação do escudo do remo, que assim como o logo da Adidas e as três listras nos ombros, ganham aplicações iridescentes.",
			preco: "R$ 79,99",
		...
		/* Esquadrão Bahia I */
		{
			...
			descricao: "As pulseiras do Senhor do Bonfim mereciam estar cravadas no o peito da camisa do Bahia em algum momento da história. Ele chegou, na temporada 2023 o Esquadrão lançou a camisa braba que está entre as dez mais tops deste ano.",
			preco: "R$ 79,99",
		...
		{ 
			...
			descricao: "Com trabalho você pode conquistar tudo! A camisa três do São Paulo para essa temporada exaltou o Tri Brasileiros em 2006, 2007 e 2008. A camisa relembrou os times históricos comandados pelo ídolo Tricolor Muricy Ramalho.",
			preco: "R$ 79,99",
		...
		/* Adidas Nashville Third */
		{
			...
			descricao: "A referência de milhões. Na terra da Country Music, a Adidas resolveu homenagear a lenda Johnny Cash e certamente é uma das camisas mais bonitas da temporada. A camisa conta até com o autógrafo do cantor.",
			preco: "R$ 99,99",
			img:"https://cdn.futfanatics.com.br/futfanatics-nacional/paginas-personalizadas/top102023/shirt/adidasNashvilleThird.png",
			link:"https://www.futfanatics.com.br/"
		},

		/* Adidas Seatle Providence Third */
		{
			nome: "Adidas Seatle Providence Third",
			descricao: "Das telas de Hollywood para o manto do Seattle Sounders. A camisa III da equipe Norte Americana é uma homenagem ao mito das lutas e do cinema mundial: Bruce Lee. A camisa faz referência aos dragões chineses, amplamente divulgado pela arte de Lee.",
			preco: "R$ 79,99",
		...
		/* Adidas Real Madrid Third */
		{
			...
			descricao: "Clássica e moderna. A camisa Third do Real Madrid exalta a elegância de ser um torcedor Merengue. A camisa conta com detalhes amarelos e a sigla do clube mais campeão do futebol mundial.",
			preco: "R$ 79,99",
		...
		{ 
			...
			descricao: "Após 20 anos do título invicto da temporada 2003/04 o Arsenal relembra a conquista histórica daquele time liderado por Henry, Viera e Wenger. A camisa home da equipe inglesa conta com raios espalhados pelo corpo, símbolo frequentemente usado nos últimos anos.",
			preco: "R$ 79,99",
		...
		/* Adidas Milan Away*/
		{
			nome: "Adidas Milan Away",
			descricao: "Alta costura milanista assinada pela Puma. Essa é a camisa away do Milan. O rossoneri é marcado em detalhes na camisa. Além disso, o corpo conta com toques da mais bela e moderna grife italiana de roupas. Como diriam os especialistas em moda: ESSA CAMISA FICOU BABADO!",
			preco: "R$ 79,99",
		...
		/* Adidas Roma Home */
		{
			nome: "Adidas Roma Home",
			descricao: "A escolha do estagiário. A camisa third da Roma marca a volta da Adidas ao clube da Cidade Eterna. Com detalhes em vermelho e amarelo, o preto clássico não passa batido. A camisa conta também com o escudo da Loba, usado nos anos 80 pelo time romanista.",
			preco: "R$ 79,99",
		...
		{ 
			...
			descricao: "A camisa do Manchester United homenageia a icônica rosa vermelha da cidade (Lancashire) e se inspira na ponte sobre o rio Irwell, que conecta Manchester e Salford, um símbolo da força da cidade e seu profundo impacto no mundo durante a revolução industrial.",
			preco: "R$ 79,99",
		 ...
		 /* Adidas Celtic Home*/
		{
			...
			descricao: "Inspirada nos vitrais do Parkhead, a camisa I do Celtic chegou forte na disputa entre as camisas mais bonitas de 2023. O clube escocês conta com o fornecimento de material esportivo da Adidas, que caprichou na camisa home.",
			preco: "R$ 79,99",
		...
		/* Adidas Benfica Home */
		{
			...
			descricao: "Os encarnados de Lisboa. A nova camisa titular do Benfica celebra os 120 anos de fundação do clube. Além disso, segue a tendência dos uniformes assinados pela Adidas em 2023. Garanto que você curtiu muito também a camisa do Benfica.",
			preco: "R$ 79,99",
		...
		{ 
			...
			descricao: "A camisa I do Racing é um deboche. Chegou na Fut para fazer todos os fãs do bom futebol sulamericano ficarem malucos. Assinado pela Kappa, o manto conta lembranças do primeiro título mundial de clubes da história, conquistado pelo clube de Avellaneda.",
			preco: "R$ 79,99",
        ...
        function renderModal(objeto) {
            $("#modal-data").html(`
				...
				<div class='col-6 d-flex flex-column align-items-center justify-content-center col-content'>			
